...
function Chatbot(_ref) {
  ...
  var _useState1 = (0, _react.useState)(0),
    ...
    unreadCount = _useState10[0],
    setUnreadCount = _useState10[1];
  var _useState11 = (0, _react.useState)(null),
    _useState12 = _slicedToArray(_useState11, 2),
    latestBroadcast = _useState12[0],
    setLatestBroadcast = _useState12[1];
  var _useState13 = (0, _react.useState)(false),
    _useState14 = _slicedToArray(_useState13, 2),
    showBroadcastPopup = _useState14[0],
    setShowBroadcastPopup = _useState14[1];
  ...
  var _useState15 = (0, _react.useState)(false),
    ...
    logoError = _useState16[0],
    setLogoError = _useState16[1];
  ...
  (0, _react.useEffect)(function () {
    ...
    if (showBroadcastPopup && !isOpen) {
      timer = setTimeout(function () {
        return setShowBroadcastPopup(false);
      }, 4000);
    }
    return function () {
